...
import { MongoAppModule } from "./mongo/mongo.module.js";

/**
 * The Blog example over MongoDB, the counterpart to `main.ts`'s Pet
 * example over TypeORM. Point `MONGO_URL` at any MongoDB instance:
 *
...
async function bootstrap(): Promise<void> {
  ...
  const app = await NestFactory.create(MongoAppModule.forRoot());
